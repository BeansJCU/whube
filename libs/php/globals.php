...
/*
 * Taken from http://php.net/manual/en/function.time.php
 *  Posted by someone without attrubution, I'm assuming public domain.
 *  If not, this should be rewritten to avoid license issues.
 */
        ...
        if ( $distanceInMinutes <= 1 ) {
            if ( !$showLessThanAMinute ) {
                ...
                if ( $distanceInSeconds < 5 ) {
                    return 'less than five seconds';
                }
                if ( $distanceInSeconds < 10 ) {
                    return 'less than ten seconds';
                }
                if ( $distanceInSeconds < 20 ) {
                    return 'less than twenty seconds';
                }
